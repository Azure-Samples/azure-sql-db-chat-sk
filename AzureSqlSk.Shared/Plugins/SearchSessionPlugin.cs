...
namespace AzureSqlSk.Shared.Plugins;
...
public class SearchSessionPlugin(Kernel kernel, ISemanticTextMemory memory, ILogger logger, string connectionString)
{
    ...
    {
        _logger.LogInformation($"Querying the database for '{logical_sql_query}'");
        ...
        {
            _logger.LogWarning("AI was not able to generate a SQL query.");
            return [];
        }
